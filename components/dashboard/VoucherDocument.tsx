...
const VoucherDocument: React.FC<VoucherDocumentProps> = ({ lead, onClose }) => {
    const handleDownload = () => {
        window.print();
    };

    return (
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm flex items-center justify-center z-[110] p-4 md:p-8 animate-[fadeIn_0.2s_ease-out] print:static print:bg-white print:p-0">
            <div className="bg-white rounded-3xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto flex flex-col animate-[scaleIn_0.3s_ease-out] print:shadow-none print:max-h-none print:w-full print:rounded-none">
                ...
                <div className="flex justify-between items-center p-6 border-b border-slate-50 bg-[#F9FBFF] print:hidden">
                    ...
                    <button
                        ...
                        className="bg-cyan-500 hover:bg-cyan-600 text-white font-bold py-2.5 px-6 rounded-xl shadow-lg flex items-center gap-2 transition-all active:scale-95"
                    >
